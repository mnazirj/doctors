<template>
    <div class="chart-1">
          ...
          <div class="chart-2">
            <Chart type="bar" :data="chartDataDoctorsAppointmentsDaily" :options="chartOptionsDoctorsAppointmentsDaily" class="h-100"  />
          </div>
</template>
...
export default {
    ...
    mounted() {
        ...
        this.chartDataDoctorsAppointmentsDaily = this.setChartDataDoctorsAppointmentsDaily();
        this.chartOptionsDoctorsAppointmentsDaily = this.setChartOptionsDoctorsAppointmentsDaily();
    },
    methods: {
