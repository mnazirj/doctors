<template>
    <div class="profile-continer d-flex justify-content-center align-items-center flex-wrap m-1 mt-1 mb-2 m-auto">
        <div class="mt-3 mb-3 d-flex justify-content-center align-content-center flex-wrap ">
            ...
            <div v-if="activeTab.value === 'Personal information'" class="info-section  mt-3 mb-3 d-flex justify-content-center flex-wrap align-content-center collapse show ">
                ...
                <div class="profile-image-container d-flex justify-content-center align-items-center flex-wrap  pt-2 pb-2 mt-3 mb-3 w-100 overflow-hidden relative"  > 
                    <div class="d-flex justify-content-center align-items-center" @mouseenter="isImageHovered = true" @mouseleave="isImageHovered = false" >
                        ...
                        <img v-else  :src="admin.img" alt="profile-image" class="profile-img " >
                        <div class=" image-overlay d-flex justify-content-center align-items-center" v-show="isImageHovered" aria-hidden="true">
                            <div class="d-flex justify-content-center">
                                <input type="file" ref="fileInput" style="display: none" @change="changeImage">
                                <i class="pi pi-pencil me-2 ms-2 cursor-pointer" title="Edit Image" @click="triggerFileInput"></i>
                                <i class="pi pi-trash me-2 ms-2 cursor-pointer " title="Delete Image" @click="deleteImage"></i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="w-100 d-flex justify-content-end align-items-center">
                    <button class="btn btn-main" title="Edit Profile" data-bs-toggle="modal" data-bs-target="#edit-profile-modal"><i class="pi pi-pen-to-square"></i></button>
                    <!-- modal edit -->
                    <div class=" modal fade" id="edit-profile-modal" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5">Edit Profile Informations</h1>
                                ...
                                <div class="modal-body">
                                    <form action="">
                                        ...
                                        <div class="mb-3 mt-3 input-group">
                                            ...
                                            <span class="input-group-text rounded-start-2" ><i class="pi pi-at text-main-color"></i></span>
                                            <input type="text" name="email" id="email" class="form-control" :value=" admin.email">
                                        </div>  
                                        <div class="mb-3 mt-3 input-group">
                                            <label class="form-label w-100" for="name">Birthday</label>
                                            <span class="input-group-text rounded-start-2" ><i class="fa-solid fa-cake-candles text-main-color"></i></span>
                                            <input type="date" name="email" id="email" class=" form-control" :value=" admin.birthday">
                                        </div>
                                        <div class="mb-3 mt-3 input-group">
                                            <label class="form-label w-100" for="name">Phone</label>
                                            <span class="input-group-text rounded-start-2"><i class="fa-solid fa-phone text-main-color"></i></span>
                                            <input type="text" name="phone" id="phone" class=" form-control" :value=" admin.mobile">
                                        </div>
                                        <div class="mb-3 mt-3 input-group">
                                            <label class="form-label w-100" for="name">Address</label>
                                            <span class="input-group-text rounded-start-2" ><i class="fa-solid fa-location-dot text-main-color"></i></span>
                                            <input type="text" name="address" id="address" class=" form-control" :value=" admin.address">
                                        </div>
                                    </form>
                                </div>
                                <div class=" modal-footer d-flex justify-content-end align-item-center">
                                    <button class=" btn btn-main" data-bs-dismiss="modal">Save</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class=" white-space-nowrap table-responsive w-100 d-flex justify-content-center flex-wrap">
                    <div class="d-flex justify-content-center align-content-center mt-2 mb-1 w-75">
                        ...
                        <p class="w-75 d-flex justify-content-start align-items-center m-1"> {{ admin.name }}</p>
                    </div>
                    <div class="d-flex justify-content-center align-content-center mt-2 mb-1 w-75">
                        <p class="w-25 d-flex justify-content-end align-items-center m-1 me-3 text-muted">Email : </p>
                        <p class="w-75 d-flex justify-content-start align-items-center m-1"> {{ admin.email }}</p>
                    </div>
                    <div class="d-flex justify-content-center align-content-cente  mt-2 mb-1 w-75">
                        <p class="w-25 d-flex justify-content-end align-items-center m-1 me-3 text-muted">Birthday : </p>
                        <p class="w-75 d-flex justify-content-start align-items-center m-1"> {{ admin.birthday }}</p>
                    </div>
                    <div class="d-flex justify-content-center align-content-center  mt-2 mb-1 w-75">
                        <p class="w-25 d-flex justify-content-end align-items-center m-1 me-3 text-muted">Phone : </p>
                        <p class="w-75 d-flex justify-content-start align-items-center m-1"> {{ admin.mobile }}</p>
                    </div>
                    <div class="d-flex justify-content-center align-content-center  mt-2 mb-1 w-75">
                        <p class="w-25 d-flex justify-content-end align-items-center m-1 me-3 text-muted">Address : </p>
                        <p class="w-75 d-flex justify-content-start align-items-center m-1"> {{ admin.address }}</p>
                    </div>
                </div>
